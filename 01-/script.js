...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    printConsole: [function(e) {
      e.preventDefault();
      H.printString(C.JSString_methods.$add("clicou em ", J.getAttribute$1$x($.link, "href")));
    }, "call$1", "link__printConsole$closure", 4, 0, 11]
  }], ["", "script.dart",, N, {
    "^": "",
    main: function(args) {
      var t1, t2;
      H.assertSubtype(args, "$isList", [P.String], "$asList");
      t1 = C.HtmlDocument_methods.querySelector$1(document, "#link");
      $.link = t1;
...
;
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, args: [,]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [,], opt: [,]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, args: [W.Event]}, {func: 1, ret: -1, args: [W.Event]}];
